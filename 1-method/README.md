...
Per-corpus canon: colometry rules, pericope rules, scholarly grounding, rules audit. Public by decision — publishing Stan's own method canon is fine; third-party licensed material is not.
