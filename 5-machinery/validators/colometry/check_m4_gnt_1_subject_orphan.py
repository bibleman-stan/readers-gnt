...
When a v1.5/grk line whose content is a subject NP (closed-list-eligible
...
Usage:
  PYTHONIOENCODING=utf-8 py -3 -m 5-machinery/validators.colometry.check_m4_gnt_1_subject_orphan
...
def check_book_chapter(book: str, chapter: int) -> List[Candidate]:
    ...
    shared across colometry 5-machinery/validators.
    """
    # Locate chapter file
