...
R28-ext (canon §3.6 "Speech-Act Announcement After Frame"):
  ...
  co-occurs on the same v1.5/grk line with a substantive preceding
...
def check_book_chapter(book: str, chapter: int) -> List[Candidate]:
    ...
    A violation is a v1.5/grk line that:
    ...
    if chapter_file is None:
        raise FileNotFoundError(
            f"v1.5/grk file not found: book={book!r} chapter={chapter}"
        )
