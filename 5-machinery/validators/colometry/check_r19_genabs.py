...
#
# Per canon §3 Pairwise Precedence Catalogue + 5-machinery/validators/README.md
...
def check_book_chapter(book: str, chapter: int) -> List[Candidate]:
    ...
    # Locate v1.5/grk chapter file via iter_v4_chapters
    ...
    if chapter_file is None:
        raise FileNotFoundError(f"v1.5/grk file not found: book={book!r} chapter={chapter}")
