...
Report is written to stdout AND to 5-machinery/validators/.canon-alignment.md.

Usage:
    py -3 5-machinery/validators/canon/check_canon_alignment.py
...
REPORT_PATH = REPO_ROOT / "5-machinery/validators" / ".canon-alignment.md"
...
RULES: list[dict] = [
    {
        ...
        "validator": "5-machinery/scripts/scan_no_anchor_lines.py",  # scanner, not colometry/
        "applier_none": False,
        "closed_lists": [],
        "ud_terms": ["finite_verb", "infinitive", "participle"],
        "branches": [],
        "notes": "5-machinery/scripts/scan_no_anchor_lines.py (scanner)",
    },
    {
        "rule_id": "R2",
        "name": "Never dangle a conjunction",
        "rule_type": "Layer 1",
        "validator": "5-machinery/validators/syntax/check_r2_no_dangle_conjunction.py",
        "applier_none": False,
        "closed_lists": [],
        "ud_terms": [],
        "branches": [],
        "notes": "5-machinery/validators/syntax/check_r2_no_dangle_conjunction.py",
    },
    {
        "rule_id": "R3",
        "name": "Never end on article",
        "rule_type": "Layer 1",
        "validator": "5-machinery/validators/syntax/check_r3_no_line_end_article.py",
        "applier_none": False,
        "closed_lists": [],
        "ud_terms": [],
        "branches": [],
        "notes": "5-machinery/validators/syntax/check_r3_no_line_end_article.py",
    },
    {
        "rule_id": "R4",
        "name": "Never split negation from negated",
        "rule_type": "Layer 1",
        "validator": "5-machinery/validators/syntax/check_r4_no_split_negation.py",
        "applier_none": False,
        "closed_lists": [],
        "ud_terms": [],
        "branches": [],
        "notes": "5-machinery/validators/syntax/check_r4_no_split_negation.py",
    },
    {
        "rule_id": "R5",
        "name": "Never split periphrastic construction",
        "rule_type": "Layer 1",
        "validator": "5-machinery/validators/syntax/check_r5_periphrastic.py",
        "applier_none": False,
        "closed_lists": [],
        "ud_terms": [],
        "branches": [],
        "notes": "5-machinery/validators/syntax/check_r5_periphrastic.py",
    },
    {
        "rule_id": "R6",
        "name": "Fixed phrases stay together",
        "rule_type": "Layer 1",
        "validator": "5-machinery/validators/syntax/check_r6_fixed_phrases.py",
        "applier_none": False,
        "closed_lists": [],
        "ud_terms": [],
        "branches": [],
        "notes": "5-machinery/validators/syntax/check_r6_fixed_phrases.py",
    },
    {
        "rule_id": "R7",
        "name": "Vocative units indivisible",
        "rule_type": "Layer 1",
        "validator": "5-machinery/validators/syntax/check_r7_vocative_units.py",
        "applier_none": False,
        "closed_lists": [],
        "ud_terms": [],
        "branches": [],
        "notes": "5-machinery/validators/syntax/check_r7_vocative_units.py",
    },
    {
        "rule_id": "R8",
        "name": "Framing devices attach",
        "rule_type": "Mechanical",
        "validator": "5-machinery/validators/syntax/check_r8_framing_devices.py",
        "applier_none": False,
    ...
    },
    {
        ...
        "rule_type": "Mechanical",
        "validator": "5-machinery/validators/syntax/check_r9_subordinate_clause.py",
        "applier_none": False,
    ...
    },
    {
        ...
        "rule_type": "Mechanical",
        "validator": "5-machinery/validators/colometry/check_r10_hoti_complementizer.py",
        "applier_none": False,
    ...
    },
    {
        ...
        "rule_type": "Mechanical",
        "validator": "5-machinery/validators/colometry/check_r11_speech_intro.py",
        "applier_none": False,
        ...
        "branches": [],
        "notes": "5-machinery/validators/colometry/check_r11_speech_intro.py",
    },
    {
        "rule_id": "R28-ext",
        "name": "Speech-act announcement after adverbial frame (split)",
        "rule_type": "Mechanical",
        "validator": "5-machinery/validators/colometry/check_r28_speech_act_frame.py",
        "applier_none": False,
        "closed_lists": ["SPEECH_LEMMAS", "TEMPORAL_CONJ"],
        # Check only Greek lemmas that must appear as string literals in validator
        "ud_terms": ["λέγω", "εἶπον", "φημί"],
        "branches": [],
        "notes": "5-machinery/validators/colometry/check_r28_speech_act_frame.py",
    },
    {
        "rule_id": "R12",
    ...
    },
    {
        ...
        "rule_type": "Mechanical",
        "validator": "5-machinery/validators/colometry/check_r17_de_contrast_overbreak.py",
        "applier_none": False,
    ...
    },
    {
        ...
        "rule_type": "Editorial",
        "validator": "5-machinery/validators/colometry/check_r18_vocative.py",
        "applier_none": False,
        "closed_lists": [],
        ...
        "branches": [],
        "notes": "5-machinery/validators/colometry/check_r18_vocative.py",
    },
    {
        "rule_id": "R18a-GNT",
        "name": "Patriarch-deity-triad indivisibility",
        "rule_type": "Mechanical",
        "validator": "5-machinery/validators/colometry/check_r18a_patriarch_triad.py",
        "applier_none": False,
        "closed_lists": [],
        # Canon names specific lemma constants by prefix strings, not uppercase consts
        "ud_terms": ["θεός", "Ἀβραάμ", "Ἰσαάκ", "Ἰακώβ"],
        "branches": [],
        "notes": "5-machinery/validators/colometry/check_r18a_patriarch_triad.py",
    },
    {
        "rule_id": "R19",
        "name": "Genitive absolute always own line",
        "rule_type": "Mechanical",
        "validator": "5-machinery/validators/colometry/check_r19_genabs.py",
        "applier_none": False,
        "closed_lists": [],
        # Canon YAML uses descriptive labels; check for the helper functions
        # the validator imports from 5-machinery/validators._shared
        "ud_terms": ["is_genitive_participle", "gen_abs"],
        "branches": [],
        "notes": "5-machinery/validators/colometry/check_r19_genabs.py",
    },
    {
        "rule_id": "R20",
        "name": "Participial phrase test (refined)",
        "rule_type": "Editorial",
        "validator": "5-machinery/scripts/scan_line_ending_participles.py",
        "applier_none": False,
        "closed_lists": [],
        "ud_terms": [],
        "branches": [],
        "notes": "5-machinery/scripts/scan_line_ending_participles.py *(scanner only)*",
    },
    {
        "rule_id": "R22",
    ...
    },
    {
        ...
        "rule_type": "Mechanical",
        "validator": "5-machinery/scripts/scan_r23_dative_infinitive.py",
        "applier_none": False,
        "closed_lists": [],
        "ud_terms": [],
        "branches": [],
        "notes": "5-machinery/scripts/scan_r23_dative_infinitive.py *(scanner only)*",
    },
    {
        "rule_id": "R24",
    ...
    },
    {
        ...
        "rule_type": "Mechanical",
        "validator": "5-machinery/validators/colometry/check_r25_hoste_consecutive_result.py",
        "applier_none": False,
        "closed_lists": [],
        ...
        "notes": "5-machinery/validators/colometry/check_r25_hoste_consecutive_result.py",
    },
    {
        "rule_id": "R27",
    ...
    },
    {
        ...
        "rule_type": "Mechanical",
        "validator": "5-machinery/validators/colometry/check_m4_gnt_1_subject_orphan.py",
        "applier_none": False,
        ...
        "branches": [],
        "notes": "5-machinery/validators/colometry/check_m4_gnt_1_subject_orphan.py",
    },
]
...
_INLINE_PATH_RE = re.compile(r"(?:5-machinery/validators|5-machinery/scripts)/[^\s)`,'\"]+\.py")
...
def find_inline_validator_in_canon(rule_id: str) -> Optional[str]:
    ...
    `5-machinery/validators/X.py` or `5-machinery/scripts/X.py` reference found within ~1.2 KB after
...
def search_fallback_for_constant(cl_name: str, primary_source: str) -> Optional[str]:
    ...
    validator source, fall back to searching `5-machinery/validators/_shared/*.py` and
    the rest of `5-machinery/validators/`. Returns the relative path of the file
    ...
    shared_dir = REPO_ROOT / "5-machinery/validators" / "_shared"
    if shared_dir.exists():
        candidates.extend(sorted(shared_dir.glob("*.py")))
    # Then the rest of 5-machinery/validators/, excluding subdirectories we've already covered
    for sub in ("colometry", "syntax", "canon"):
        sub_dir = REPO_ROOT / "5-machinery/validators" / sub
        if sub_dir.exists():
...
def check_rule(rule: dict) -> tuple[str, str]:
    ...
    # Protocol scope (a): fall back to 5-machinery/validators/_shared/ + rest of 5-machinery/validators/
...
def build_report() -> str:
    ...
    lines: list[str] = [
        ...
        f"",
        f"Generated by `5-machinery/validators/canon/check_canon_alignment.py`.",
