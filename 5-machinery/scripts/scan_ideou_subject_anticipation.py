...
Run:
  PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/scan_ideou_subject_anticipation.py
  PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/scan_ideou_subject_anticipation.py --book matt
"""
