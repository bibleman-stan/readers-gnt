...
Usage:
    PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/scan_no_anchor_lines.py
    PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/scan_no_anchor_lines.py --book rom
"""
import os
import re
import sys
