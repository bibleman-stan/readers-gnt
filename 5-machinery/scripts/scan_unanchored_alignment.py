...
Usage
-----
  PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/scan_unanchored_alignment.py
  PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/scan_unanchored_alignment.py --book mark
  PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/scan_unanchored_alignment.py --output report.md
"""
