#!/usr/bin/env python3
"""
Scan all 260 v1.5/grk chapter files for lines where a participial phrase
...
V4_DIR = os.path.join(BASE, "data", "text-files", "v1.5", "grk")

# Mapping from morphgnt file prefix to v1.5/grk folder/file prefix
BOOK_MAP = {
    "61": ("01-matt", "matt"),
    "62": ("02-mark", "mark"),
    "63": ("03-luke", "luke"),
