...
Run as:
  py -3 5-machinery/scripts/scan_eng_kjv_coverage.py
  py -3 5-machinery/scripts/scan_eng_kjv_coverage.py --baseline-check
  py -3 5-machinery/scripts/scan_eng_kjv_coverage.py --update-baseline
...
def write_baseline(misses: list[tuple[str, str, int, str]]) -> None:
    payload = {
        "_note": (
            ...
            "5-machinery/scripts/scan_eng_kjv_coverage.py --update-baseline after "
    ...
    if args.baseline_check:
        ...
        if new:
            ...
            print(
                ...
                "5-machinery/scripts/scan_eng_kjv_coverage.py --update-baseline"
            )
            return 1
        if resolved:
