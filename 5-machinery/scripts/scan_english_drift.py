...
Usage:
    PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/scan_english_drift.py
    PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/scan_english_drift.py --book rom
    PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/scan_english_drift.py --summary-only
"""
import os
import re
import argparse
