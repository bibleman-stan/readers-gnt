#!/usr/bin/env python3
"""
Colometric Stylometry for the Greek New Testament v1.5/grk corpus.
...
Run:
  PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/colometric_stylometry.py
"""
...
def main():
    print(f"Reading v1.5/grk from {V4_DIR}")
    ...
    with open(summary_path, "w", encoding="utf-8") as f:
        f.write("GNT COLOMETRIC STYLOMETRY - v1.5/grk corpus\n")
        f.write("=" * 72 + "\n\n")
