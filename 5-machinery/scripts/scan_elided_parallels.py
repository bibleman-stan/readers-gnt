...
Usage:
    PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/scan_elided_parallels.py
    PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/scan_elided_parallels.py --book gal
"""
...
V4_DIR = os.path.join(REPO_DIR, "data", "text-files", "v1.5", "grk")
