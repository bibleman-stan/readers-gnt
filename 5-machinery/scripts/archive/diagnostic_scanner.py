...
Usage:
    PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/archive/diagnostic_scanner.py --chapter mark-04
    PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/archive/diagnostic_scanner.py --all-mark
    PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/archive/diagnostic_scanner.py --book mark
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="Colometric diagnostic scanner — 5-machinery/tests lines against three criteria"
    )
