...
Usage:
    py -3 5-machinery/scripts/archive/v2_colometry.py                              # all books
    py -3 5-machinery/scripts/archive/v2_colometry.py --book Acts                  # one book
    py -3 5-machinery/scripts/archive/v2_colometry.py --book Acts --chapter 1      # one chapter
