...
Usage:
    py -3 5-machinery/scripts/archive/v3_colometry.py                              # all books
    py -3 5-machinery/scripts/archive/v3_colometry.py --book Mark                  # one book
    py -3 5-machinery/scripts/archive/v3_colometry.py --book Mark --chapter 4      # one chapter
