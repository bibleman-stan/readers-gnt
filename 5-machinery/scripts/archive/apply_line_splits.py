...
Usage:
  ...
  PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/apply_line_splits.py --class hoti --limit 10 [--apply]
  PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/apply_line_splits.py --class reverse --limit 10 [--apply]
  # Full
  PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/apply_line_splits.py --class hoti [--apply]
  PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/apply_line_splits.py --class reverse [--apply]
