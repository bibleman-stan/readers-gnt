...
Usage:
    py -3 5-machinery/scripts/archive/auto_colometry.py                     # format all books
    py -3 5-machinery/scripts/archive/auto_colometry.py --book Mark         # format one book
    py -3 5-machinery/scripts/archive/auto_colometry.py --book Mark --chapter 4   # format one chapter
