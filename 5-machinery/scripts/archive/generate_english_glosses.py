...
Usage:
    PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/archive/generate_english_glosses.py --books rom,1cor,2cor
    PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/archive/generate_english_glosses.py --books mark
"""
