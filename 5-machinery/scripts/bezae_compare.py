...
Usage:
    PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/bezae_compare.py                                    # full report
    PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/bezae_compare.py --book mark                        # one book
    PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/bezae_compare.py --book mark --chapter 4 --side-by-side  # side by side
"""
...
TIER_DIRS = {
    ...
    "v4": PROJECT_DIR / "data" / "text-files" / "v1.5" / "grk",
}
...
def load_v3_book(book_prefix, chapter_filter=None, input_dir=None):
    ...
    For v1.5/grk, falls back to v3-colometric for chapters not yet in v4.
    ...
    # v1.5/grk uses book subfolders; other tiers are flat
