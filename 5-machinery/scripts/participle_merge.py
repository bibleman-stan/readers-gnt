...
Usage:
    PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/participle_merge.py --dry-run
    PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/participle_merge.py
    PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/participle_merge.py --book mark
"""
...
def _parse_line_with_verse_markers(line_text, primary_verse):
    """Parse a v1.5/grk line that may contain inline cross-verse markers.
...
def discover_files(book_filter=None):
    """Discover all v1.5/grk files, optionally filtered by book."""
    files = []
