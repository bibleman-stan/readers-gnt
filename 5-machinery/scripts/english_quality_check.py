...
Usage:
    PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/english_quality_check.py              # all files
    PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/english_quality_check.py --book mark   # one book
"""
...
ENG_DIR = REPO_ROOT / "data" / "text-files" / "v1.5" / "eng-kjv"
