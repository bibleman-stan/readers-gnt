...
# case tokens on one line. Predicates copied verbatim from 5-machinery/validators/syntax/
...
def _rtok(w, v0):
    ...
    5-machinery/validators actually see in v1.5/grk."""
...
def emit_v4(lowfat, morph, v0dir, slug, chap):
    ...
    # 5-machinery/scripts/gnt_overrides.py + data/text-files/v1.5-adjudicated/grk/README.md.
