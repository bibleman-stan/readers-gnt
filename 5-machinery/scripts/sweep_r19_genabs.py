...
v1.5/grk files in place.

Usage:
  dry:   PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/sweep_r19_genabs.py
  apply: PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/sweep_r19_genabs.py --apply
"""
import os, re, sys
