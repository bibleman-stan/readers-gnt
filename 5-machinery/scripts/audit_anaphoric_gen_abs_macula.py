...
Output:
  - Fixture pass/fail against `5-machinery/tests/fixtures-anaphoric-gen-abs.tsv`
...
sys.path.insert(0, str(REPO_ROOT / "5-machinery/validators" / "_shared"))

import macula_clauses as MC

V4_GRK_DIR = REPO_ROOT / "data" / "text-files" / "v1.5" / "grk"
FIXTURE = REPO_ROOT / "5-machinery/tests" / "fixtures-anaphoric-gen-abs.tsv"
