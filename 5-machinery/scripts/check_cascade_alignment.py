...
Scans data/text-files/v1.5/eng-kjv/ against v1.5/grk/ for mechanical
...
Usage:
    py -3 5-machinery/scripts/check_cascade_alignment.py                    # all books
    py -3 5-machinery/scripts/check_cascade_alignment.py --book matt        # one book
    py -3 5-machinery/scripts/check_cascade_alignment.py --book matt --chapter 4
    py -3 5-machinery/scripts/check_cascade_alignment.py --output /tmp/warnings.md
"""
...
_V4_ROOT = _REPO_ROOT / "data" / "text-files" / "v1.5" / "grk"
_ENG_ROOT = _REPO_ROOT / "data" / "text-files" / "v1.5" / "eng-kjv"
