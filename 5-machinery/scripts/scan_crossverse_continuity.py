...
Usage:
    PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/scan_crossverse_continuity.py
    PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/scan_crossverse_continuity.py --book matt
    PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/scan_crossverse_continuity.py --summary-only
"""
import os
import re
import sys
