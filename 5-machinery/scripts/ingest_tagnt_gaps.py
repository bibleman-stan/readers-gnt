...
Does NOT modify v1.5/grk. Hand-editorial ATU line-breaking is a
separate step.

Usage:
    python3 5-machinery/scripts/ingest_tagnt_gaps.py [--dry-run]
...
GAP_PASSAGES = [
    ...
    # Rom 16:24 is present in v1.5/grk (SBL includes it via KO type).
