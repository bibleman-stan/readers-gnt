...
This scan 5-machinery/tests whether the pattern fires on other verses.
...
Usage: PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/scan_r23_dative_infinitive.py
"""
import os, re
