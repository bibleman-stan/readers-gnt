...
Finds lines in v1.5/grk where an attributive participle (or adjective)
...
Usage:
  PYTHONIOENCODING=utf-8 py -3 5-machinery/scripts/detect_attributive_splits.py
"""
...
V4_DIR = os.path.join(REPO, "data", "text-files", "v1.5", "grk")

# Book mapping: MorphGNT prefix -> v1.5/grk folder name
BOOK_MAP = {
...
# Folder number prefixes in v1.5/grk
FOLDER_NUM = {
...
def parse_v4_file(filepath):
    """Parse a v1.5/grk file into verses with their lines.
...
def detect_splits():
    ...
    # Iterate over all v1.5/grk files
